...
export const CANTEENS: Record<string, Canteen> = {
  aditya: {
    ...
    kpis: { revenue: 38420, revenueDelta: "▲ ₹4,230 vs yesterday", orders: 248, ordersDelta: "▲ 19 vs yesterday", avgTicket: 155, avgTicketDelta: "▲ ₹6", avgPickupMin: 7, avgPickupSec: 12, avgPickupDelta: "▼ 0:18 slower" },
    topItems: [
    ...
    studentRows: [
      { name: "Ananya R.", roll: "reg-01", orders: 12, spend: 1840, last: "11:42" },
      { name: "Karthik V.", roll: "reg-14", orders: 9, spend: 1420, last: "11:41" },
      { name: "Priya M.", roll: "reg-22", orders: 11, spend: 1560, last: "11:40" },
      { name: "Rohit S.", roll: "reg-08", orders: 7, spend: 980, last: "11:37" },
      { name: "Devansh K.", roll: "reg-31", orders: 6, spend: 720, last: "11:35" },
      { name: "Sneha P.", roll: "reg-19", orders: 10, spend: 1310, last: "11:32" },
    ],
    menuModal: [
      { name: "Chicken Biryani", price: 140, live: true },
      { name: "Paneer Butter Masala", price: 160, live: true },
      { name: "Veg Thali", price: 120, live: true },
      { name: "Masala Dosa", price: 70, live: true },
      { name: "Filter Coffee", price: 25, live: true },
  ...
  "north-block": {
    ...
    kpis: { revenue: 22180, revenueDelta: "▲ ₹1,290 vs yesterday", orders: 186, ordersDelta: "▲ 7 vs yesterday", avgTicket: 119, avgTicketDelta: "▲ ₹4", avgPickupMin: 5, avgPickupSec: 48, avgPickupDelta: "▲ 0:12 faster" },
    topItems: [
    ...
    studentRows: [
      { name: "Isha K.", roll: "reg-04", orders: 14, spend: 1260, last: "12:08" },
      { name: "Naveen L.", roll: "reg-11", orders: 8, spend: 890, last: "12:07" },
      { name: "Zara H.", roll: "reg-19", orders: 10, spend: 1040, last: "12:05" },
      { name: "Arjun P.", roll: "reg-07", orders: 6, spend: 520, last: "12:02" },
    ],
    menuModal: [
    ...
    audit: [
      ...
      { t: "11:48:33", type: "prep", who: "system", msg: "rush mode off · 5th Cross" },
    ],
  ...
  "hostel-b": {
    ...
    categories: [
      { id: "all", label: "All items", sub: "Today's board" },
      { id: "meal", label: "Meals", sub: "Rice plates" },
      { id: "extras", label: "Extras", sub: "Add-ons" },
      { id: "drinks", label: "Drinks", sub: "Buttermilk & chai" },
    ],
    menu: [
      { id: "mess-thali", name: "Full Meals", desc: "Rice, sambar, poriyal, curd", price: 70, cat: "meal", diet: "veg", emoji: "🍽" },
      { id: "spl-thali", name: "Special Meals", desc: "Extra sabzi + sweet", price: 90, cat: "meal", diet: "veg", emoji: "🥘" },
      ...
      { id: "banana", name: "Banana (2)", desc: "From the fruit basket", price: 20, cat: "extras", diet: "veg", emoji: "🍌" },
    ],
    kitchenTickets: [
      { id: "T-902", student: "Ravi M.", status: "incoming", elapsedSec: 38, total: 70, otp: "4021", items: [{ name: "Full Meals", diet: "veg", tgt: 6, q: 1 }] },
      { id: "T-901", student: "Sana J.", status: "incoming", elapsedSec: 72, total: 105, otp: "7193", items: [{ name: "Special Meals", diet: "veg", tgt: 7, q: 1 }, { name: "Spiced Buttermilk", diet: "veg", tgt: 1, q: 1 }] },
      { id: "T-900", student: "Omar F.", status: "preparing", elapsedSec: 210, total: 85, otp: "3056", items: [{ name: "Egg Curry Meal", diet: "nonveg", tgt: 8, q: 1 }] },
      { id: "T-899", student: "Divya C.", status: "preparing", elapsedSec: 390, total: 90, otp: "8840", items: [{ name: "Curd Rice", diet: "veg", tgt: 4, q: 2 }] },
      { id: "T-898", student: "Harsh G.", status: "ready", elapsedSec: 320, total: 140, otp: "1297", items: [{ name: "Full Meals", diet: "veg", tgt: 6, q: 2 }] },
      { id: "T-897", student: "Neha B.", status: "collected", elapsedSec: 650, total: 35, otp: "3384", items: [{ name: "Banana (2)", diet: "veg", tgt: 1, q: 1 }, { name: "Spiced Buttermilk", diet: "veg", tgt: 1, q: 1 }] },
    ],
    defaultSpecials: [
      { id: "hb1", name: "Chicken Curry Special", desc: "Limited plates · till stock lasts", price: 100, prep: 10, diet: "nonveg", icon: "C", addedAt: now() - 25 * 60 * 1000 },
    ],
    kitchenDishes: [
      { name: "Full Meals", diet: "veg", tgt: 6 },
      { name: "Special Meals", diet: "veg", tgt: 7 },
    ...
    kpis: { revenue: 14260, revenueDelta: "▲ ₹430 vs yesterday", orders: 230, ordersDelta: "▲ 21 vs yesterday", avgTicket: 62, avgTicketDelta: "▲ ₹3", avgPickupMin: 4, avgPickupSec: 5, avgPickupDelta: "▲ 0:08 faster" },
    topItems: [
      { name: "Full Meals", diet: "veg", orders: 96, pct: 95 },
      { name: "Spiced Buttermilk", diet: "veg", orders: 74, pct: 80 },
      { name: "Special Meals", diet: "veg", orders: 38, pct: 62 },
      { name: "Egg Curry Meal", diet: "nv", orders: 22, pct: 40 },
      { name: "Curd Rice", diet: "veg", orders: 21, pct: 38 },
    ],
    orders: [
      { id: "T-902", student: "Ravi M.", items: "Full Meals × 1", total: 70, status: "incoming", time: "12:35" },
      { id: "T-901", student: "Sana J.", items: "Special Meals × 1, Buttermilk × 1", total: 105, status: "preparing", time: "12:34" },
      { id: "T-900", student: "Omar F.", items: "Egg Curry Meal × 1", total: 85, status: "preparing", time: "12:33" },
      { id: "T-899", student: "Divya C.", items: "Curd Rice × 2", total: 90, status: "ready", time: "12:30" },
      { id: "T-898", student: "Harsh G.", items: "Full Meals × 2", total: 140, status: "collected", time: "12:28" },
      { id: "T-897", student: "Neha B.", items: "Banana × 1, Buttermilk × 1", total: 35, status: "collected", time: "12:25" },
      { id: "T-896", student: "Ravi M.", items: "Special Meals × 1", total: 90, status: "ready", time: "12:22" },
    ],
    studentRows: [
      { name: "Ravi M.", roll: "reg-104", orders: 22, spend: 1540, last: "12:35" },
      { name: "Sana J.", roll: "reg-208", orders: 19, spend: 1330, last: "12:34" },
      { name: "Omar F.", roll: "reg-112", orders: 15, spend: 980, last: "12:33" },
      { name: "Divya C.", roll: "reg-305", orders: 18, spend: 1120, last: "12:30" },
    ],
    menuModal: [
      { name: "Full Meals", price: 70, live: true },
      { name: "Special Meals", price: 90, live: true },
      { name: "Egg Curry Meal", price: 85, live: true },
      { name: "Curd Rice", price: 45, live: true },
      { name: "Chicken Curry Special", price: 100, live: true },
    ],
    audit: [
      { t: "12:32:01", type: "pay", who: "system", msg: "UPI ₹70 received · matched to T-902" },
      { t: "12:20:44", type: "menu", who: "owner", msg: "put Chicken Curry Special on the board" },
      { t: "11:55:12", type: "prep", who: "owner", msg: "set closing time to 2:00 PM" },
    ],
    spDefaults: { name: "Chicken Curry Special", desc: "Limited plates · till stock lasts", price: 100, prep: 10, diet: "nonveg" },
    counterBase: 900,
  },
};
